...
Chiamiamo $C$ il numero minimo di bit necessari per discriminare il tipo di messaggio, la leader election con saturazione del minimo
comporta:
\begin{align*}
& \text{bits num} \leq
...
\subsubsection{Controlled Distance (HS)}
