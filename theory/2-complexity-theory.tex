...
\defbox{
  ...
  mantenendo la natura dell'istanza: se era positiva per $A$, deve essere positiva anche per $B$; se era negativa per $A$,
...
\texttt{
istanza HC -> |poly.\ conv.| -> |TSP solv.| -> |poly.\ conv.| -> Y/N
}
  \newline \newline
